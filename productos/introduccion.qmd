...
Si bien este gráfico es informativo, nos surge la duda el saber cuándo y donde se presentaron las ventas. Para esto, tenemos el siguiente gráfico
...
Analizando más detalladamente el año con mayor lanzamiento de videojuegos, llegamos al siguiente gráfico
...
en este gráfico se puede apreciar claramente la moda de lanzamientos de ese año, el cual fué para la plataforma Nintendo DS, con 405 videojuegos. En segundo lugar tenemos a la Nintendo Wii con 325 videojuegos y en tercer lugar a la Xbox 360, con 173 lanzamientos. Observamos que el primer y segundo lugar de lanzamientos del año 2009 estuvo bajo Nintendo. Esto se puede explicar, al igual que la @fig-cant-juegos-xaño, por la llegada de las consolas de séptima generación, que en este caso vendría por parte de la consola Nintendo DSi y Nintendo Wii, los años 2008 y 2006 respectivamente.[Ver Anexo](https://es.wikipedia.org/wiki/Anexo:Videoconsolas_de_Nintendo)
